  ...
  module Cloud
    module Datastore
      ...
      class Dataset
        ...
        # @param [Google::Protobuf::Timestamp] read_time Reads entities as they were at the given time.
        #   This may not be older than 270 seconds. This value is only supported for Cloud Firestore in
        #   Datastore mode. Optional
        #
        ...
        #   Transactions
        #
        # @param [Google::Protobuf::Timestamp] read_time Reads entities at the given time.
