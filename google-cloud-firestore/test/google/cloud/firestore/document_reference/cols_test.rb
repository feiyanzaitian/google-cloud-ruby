...
describe Google::Cloud::Firestore::DocumentReference, :col, :mock_firestore do
  ...
  describe "using read time" do
    it "iterates collections with pagination" do
      shallow_doc = Google::Cloud::Firestore::DocumentReference.from_path parent, firestore
      firestore_mock.expect :list_collection_ids, first_page, list_collection_ids_args(parent: parent, read_time: read_time)
      firestore_mock.expect :list_collection_ids, second_page, list_collection_ids_args(parent: parent, page_token: "next_page_token", read_time: read_time)
      firestore_mock.expect :list_collection_ids, last_page, list_collection_ids_args(parent: parent, page_token: "next_page_token", read_time: read_time)
    ...
    it "iterates collections from top-level document" do
      ...
      firestore_mock.expect :list_collection_ids, list_collection_ids_resp("messages", "follows", "followers"), list_collection_ids_args(parent: shallow_doc.path, read_time: read_time)
    ...
    it "iterates collections from nested document" do
      ...
      firestore_mock.expect :list_collection_ids, list_collection_ids_resp("likes", "saves", "hearts"), list_collection_ids_args(parent: nested_doc.path, read_time: read_time)
    ...
    it "iterates collections from a document that does not exist" do
      ...
      firestore_mock.expect :list_collection_ids, list_collection_ids_resp, list_collection_ids_args(parent: missing_doc.path, read_time: read_time)
